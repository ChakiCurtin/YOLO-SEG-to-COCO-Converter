...
def main(args: argparse.Namespace):
    ...
    category = get_categories() # in this case, It is already populated with all the right things
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--show", required=False, action="store_true", help="Toogle showing images with output mask and bounding boxes")
